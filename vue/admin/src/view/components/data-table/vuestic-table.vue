...
import FilterBar from 'vuestic-components/vuestic-datatable/datatable-components/FilterBar.vue'
import ItemsPerPage from 'vuestic-components/vuestic-datatable/datatable-components/ItemsPerPage.vue'
import DefaultPerPageDefinition from 'vuestic-components/vuestic-datatable/data/items-per-page-definition'
